...
train_pipeline = [
    ...
    dict(
        type='Resize',
        img_scale=(512, 512),#img_scale=[(750, 500), (2100, 1400)],
    ...
    dict(
        ...
        cutout_shape=[(4, 4), (4, 8), (8, 4), (8, 8),
                      ...
                      (32, 48), (48, 32), (48, 48)],
        cutout_p=0.5),
    dict(type='Rotate', level=7,prob=0.8, max_rotate_angle=360),
    dict(type='ColorTransform', level=7),
    dict(type='Translate', level=7),
    #dict(type='RandomCenterCropPad'),
    #dict(type='Color', prob=0.7, level=6),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(512, 512),#img_scale=(1333, 800),
        flip=False,
        transforms=[
